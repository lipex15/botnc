...
Nova geração do Bot NC, isolada das tentativas anteriores que permanecem na raiz do
repositório somente como referência histórica.
...
```powershell
dotnet build ./next/BotNC.slnx
dotnet run --project ./next/src/BotNC.App/BotNC.App.csproj
```
